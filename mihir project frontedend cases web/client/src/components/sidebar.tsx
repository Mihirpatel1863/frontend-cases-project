  ...
  return (
    <aside className="w-full md:w-64 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800 text-white flex flex-col h-full md:h-screen shadow-2xl border-r border-slate-700/40 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none">
        ...
        <div className="absolute top-1/2 right-0 w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-bl from-emerald-500 to-cyan-500 rounded-full filter blur-xl"></div>
      </div>

      <div className="relative z-10 flex flex-col flex-grow">
        {/* Header */}
        <div className="p-4 sm:p-6 border-b border-slate-700/60">
          <h1 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-white via-teal-200 to-blue-200 bg-clip-text text-transparent float-animation">
            LexiAI
          </h1>
